...
class UpdateService {
  ...
  static const String GITHUB_API = "https://api.github.com/repos/Twenethomas/aniwasmartlens/releases/latest";
  ...
  Future<void> checkAndInstallUpdate() async {
    try {
      ...
      final response = await http.get(Uri.parse(GITHUB_API));
